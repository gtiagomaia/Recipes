...
class TableViewController: UITableViewController {
    ...
    private let database = (UIApplication.shared.delegate as! AppDelegate).dbconnect
    private var dictionary: Dictionary<Category, [Recipe]> = [Category: [Recipe]]() //init empty dictionary like .init()
...
//
    ...
    // MARK - action for left b ar button item
